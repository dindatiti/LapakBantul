...
class _SplashScreenState extends State<SplashScreen> {
  ...
  static const _pages = [
    _SplashData(
      ...
      description: 'Pusat Layanan Pajak Terpadu Kabupaten Bantul yang mudah, cepat, dan transparan.',
      icon: Icons.account_balance,
      color: Color(0xFF003566),
    ),
    _SplashData(
      title: 'Kelola Semua Pajak Anda',
      description: 'Bayar dan pantau PBB, Pajak Kendaraan, dan Pajak Usaha Anda dalam satu aplikasi.',
      icon: Icons.receipt_long,
      color: Color(0xFF005A9E),
    ),
    _SplashData(
      title: 'Layanan Keliling Hadir untuk Anda',
      description: 'Kami hadir di dekat Anda melalui layanan pajak keliling. Cek jadwal dan lokasi terkini.',
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 32),
              child: Text(data.title, textAlign: TextAlign.center, style: const TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Colors.white)),
            ),
            const SizedBox(height: 16),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 40),
              child: Text(data.description, textAlign: TextAlign.center, style: const TextStyle(fontSize: 16, color: Colors.white70, height: 1.6)),
            ),
          ],
        ),
      ),
